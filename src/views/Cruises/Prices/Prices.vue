...
<div class="grid-demo__layout-container">
  <vs-row vs-w="12">
    <vs-col vs-type="flex"   vs-lg="4" vs-sm="4" vs-xs="12"  >
      <vs-table ref="vesselTable" v-model="selected" :data="vessels">
        <template slot="thead">
          <vs-th sort-key="name">Select Vessel</vs-th>
        </template>
    ...
    <vs-col vs-type="block"  vs-align="center" vs-lg="8" vs-sm="4" vs-xs="12"> 
      <div
            ...
            <vs-dropdown vs-trigger-click class="cursor-pointer mb-4 mr-4">
              ...
              >
                <span class="mr-2"
                  ...
                  {{
                    ports.length - currentPage * itemsPerPage > 0
              ...
              <vs-tr :data="port" :key="_id" v-for="(port, _id) in data">
                ...
                <vs-td class="whitespace-no-wrap">
                  ...
                  <feather-icon
                    ...
                    class="ml-4"
                    @click.stop="editData(port)"
                  />
                  <feather-icon
                    icon="TrashIcon"
                    svgClasses="w-7 h-7 hover:text-danger stroke-current"
                    class="ml-4"
                    @click.stop="deleteData(port._id)"
                  />
                </vs-td>
              </vs-tr>
            </tbody>
...
export default {
  ...
  computed: {
    currentPage () {
      if (this.isMounted) {
        return this.$refs.vesselTable.currentx
        return this.$refs.priceTable.currentx
